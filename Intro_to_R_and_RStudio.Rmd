...
```{r setup Exercise 2.3}
    ...
    knitr::opts_knit$set(root.dir = normalizePath("/Users/Anton/Documents/QBIO490/qbio_490_antonwagner")) 
```
...
string_var <- "This is QBIO490's Fall 2023 class!"
char_var <- 'x'
...
age <- 19
birthday <- "03/11/2004"
three_fav_colors <- c("red", "green", "yellow")
...
## call functions here
sum_value = sum(list_of_numbers)
sum_value
min_value = min(list_of_numbers)
min_value
mean_value = mean(list_of_numbers)
mean_value
mode_value = mode(list_of_numbers)
mode_value
summary_value = summary(list_of_numbers)
summary_value
...
```{r Exercise 9.2}
# write code here
mtcars$transmission <- ifelse(mtcars[,"am"] == 0, "automatic", "manuel")
